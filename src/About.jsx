...
export default function About({ onHomeClick }) {
    ...
    <div className="about-3d-fullpage">
      ...
      <div className="about-3d-content">
        ...
        <button
          ...
          onClick={() => { playBloop(); setShowFrameworks(v => !v); }}
        >
          {showFrameworks ? 'Hide' : 'Show'} Frameworks & Specialized Areas
        </button>

        {showFrameworks && (
          <section className="about-frameworks-panel">
        ...
        {onHomeClick && (
          <button className="about-home-btn" onClick={() => { playBloop(); onHomeClick(); }}>
            ← Home
          </button>
        )}
      </div>
